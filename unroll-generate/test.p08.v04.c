...
clock_t kernel() {
  ...
  for (int i_0 = 1; i_0 < 499; ++i_0) {
    for (int i_1 = 1; i_1 < 499; ++i_1) {
      ...
      for (int i_2 = 6; i_2 < 492; i_2+=18) {
        (*B)[i_0][i_1][(i_2 + 0)] = ((*A)[(i_0 - 1)][(i_1 - 1)][(i_2 + 0)] - (*B)[i_0][i_1][(i_2 + 0)]);
        (*B)[i_0][i_1][(i_2 + 1)] = ((*A)[(i_0 - 1)][(i_1 - 1)][(i_2 + 1)] - (*B)[i_0][i_1][(i_2 + 1)]);
        (*B)[i_0][i_1][(i_2 + 2)] = ((*A)[(i_0 - 1)][(i_1 - 1)][(i_2 + 2)] - (*B)[i_0][i_1][(i_2 + 2)]);
        (*B)[i_0][i_1][(i_2 + 3)] = ((*A)[(i_0 - 1)][(i_1 - 1)][(i_2 + 3)] - (*B)[i_0][i_1][(i_2 + 3)]);
        (*B)[i_0][i_1][(i_2 + 4)] = ((*A)[(i_0 - 1)][(i_1 - 1)][(i_2 + 4)] - (*B)[i_0][i_1][(i_2 + 4)]);
        (*B)[i_0][i_1][(i_2 + 5)] = ((*A)[(i_0 - 1)][(i_1 - 1)][(i_2 + 5)] - (*B)[i_0][i_1][(i_2 + 5)]);
        (*B)[i_0][i_1][(i_2 + 6)] = ((*A)[(i_0 - 1)][(i_1 - 1)][(i_2 + 6)] - (*B)[i_0][i_1][(i_2 + 6)]);
        (*B)[i_0][i_1][(i_2 + 7)] = ((*A)[(i_0 - 1)][(i_1 - 1)][(i_2 + 7)] - (*B)[i_0][i_1][(i_2 + 7)]);
        (*B)[i_0][i_1][(i_2 + 8)] = ((*A)[(i_0 - 1)][(i_1 - 1)][(i_2 + 8)] - (*B)[i_0][i_1][(i_2 + 8)]);
        (*B)[i_0][i_1][(i_2 + 9)] = ((*A)[(i_0 - 1)][(i_1 - 1)][(i_2 + 9)] - (*B)[i_0][i_1][(i_2 + 9)]);
        (*B)[i_0][i_1][(i_2 + 10)] = ((*A)[(i_0 - 1)][(i_1 - 1)][(i_2 + 10)] - (*B)[i_0][i_1][(i_2 + 10)]);
        (*B)[i_0][i_1][(i_2 + 11)] = ((*A)[(i_0 - 1)][(i_1 - 1)][(i_2 + 11)] - (*B)[i_0][i_1][(i_2 + 11)]);
        (*B)[i_0][i_1][(i_2 + 12)] = ((*A)[(i_0 - 1)][(i_1 - 1)][(i_2 + 12)] - (*B)[i_0][i_1][(i_2 + 12)]);
        (*B)[i_0][i_1][(i_2 + 13)] = ((*A)[(i_0 - 1)][(i_1 - 1)][(i_2 + 13)] - (*B)[i_0][i_1][(i_2 + 13)]);
        (*B)[i_0][i_1][(i_2 + 14)] = ((*A)[(i_0 - 1)][(i_1 - 1)][(i_2 + 14)] - (*B)[i_0][i_1][(i_2 + 14)]);
        (*B)[i_0][i_1][(i_2 + 15)] = ((*A)[(i_0 - 1)][(i_1 - 1)][(i_2 + 15)] - (*B)[i_0][i_1][(i_2 + 15)]);
        (*B)[i_0][i_1][(i_2 + 16)] = ((*A)[(i_0 - 1)][(i_1 - 1)][(i_2 + 16)] - (*B)[i_0][i_1][(i_2 + 16)]);
        (*B)[i_0][i_1][(i_2 + 17)] = ((*A)[(i_0 - 1)][(i_1 - 1)][(i_2 + 17)] - (*B)[i_0][i_1][(i_2 + 17)]);
      }
      for (int i_2 = 492; i_2 < 499; ++i_2) {
        (*B)[i_0][i_1][i_2] = ((*A)[(i_0 - 1)][(i_1 - 1)][i_2] - (*B)[i_0][i_1][i_2]);
      }
    }
  }
