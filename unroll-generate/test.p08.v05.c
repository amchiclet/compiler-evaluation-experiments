...
clock_t kernel() {
  ...
  for (int i_0 = 2; i_0 < 497; i_0+=11) {
    for (int i_1 = 1; i_1 < 499; ++i_1) {
      for (int i_2 = 1; i_2 < 499; ++i_2) {
        (*B)[(i_0 + 0)][i_1][i_2] = ((*A)[((i_0 + 0) - 1)][(i_1 - 1)][i_2] - (*B)[(i_0 + 0)][i_1][i_2]);
      }
    }
    for (int i_1 = 1; i_1 < 499; ++i_1) {
      for (int i_2 = 1; i_2 < 499; ++i_2) {
        (*B)[(i_0 + 1)][i_1][i_2] = ((*A)[((i_0 + 1) - 1)][(i_1 - 1)][i_2] - (*B)[(i_0 + 1)][i_1][i_2]);
      }
    }
    for (int i_1 = 1; i_1 < 499; ++i_1) {
      for (int i_2 = 1; i_2 < 499; ++i_2) {
        (*B)[(i_0 + 2)][i_1][i_2] = ((*A)[((i_0 + 2) - 1)][(i_1 - 1)][i_2] - (*B)[(i_0 + 2)][i_1][i_2]);
      }
    }
    for (int i_1 = 1; i_1 < 499; ++i_1) {
      for (int i_2 = 1; i_2 < 499; ++i_2) {
        (*B)[(i_0 + 3)][i_1][i_2] = ((*A)[((i_0 + 3) - 1)][(i_1 - 1)][i_2] - (*B)[(i_0 + 3)][i_1][i_2]);
      }
    }
    for (int i_1 = 1; i_1 < 499; ++i_1) {
      for (int i_2 = 1; i_2 < 499; ++i_2) {
        (*B)[(i_0 + 4)][i_1][i_2] = ((*A)[((i_0 + 4) - 1)][(i_1 - 1)][i_2] - (*B)[(i_0 + 4)][i_1][i_2]);
      }
    }
    for (int i_1 = 1; i_1 < 499; ++i_1) {
      for (int i_2 = 1; i_2 < 499; ++i_2) {
        (*B)[(i_0 + 5)][i_1][i_2] = ((*A)[((i_0 + 5) - 1)][(i_1 - 1)][i_2] - (*B)[(i_0 + 5)][i_1][i_2]);
      }
    }
    for (int i_1 = 1; i_1 < 499; ++i_1) {
      for (int i_2 = 1; i_2 < 499; ++i_2) {
        (*B)[(i_0 + 6)][i_1][i_2] = ((*A)[((i_0 + 6) - 1)][(i_1 - 1)][i_2] - (*B)[(i_0 + 6)][i_1][i_2]);
      }
    }
    for (int i_1 = 1; i_1 < 499; ++i_1) {
      for (int i_2 = 1; i_2 < 499; ++i_2) {
        (*B)[(i_0 + 7)][i_1][i_2] = ((*A)[((i_0 + 7) - 1)][(i_1 - 1)][i_2] - (*B)[(i_0 + 7)][i_1][i_2]);
      }
    }
    for (int i_1 = 1; i_1 < 499; ++i_1) {
      for (int i_2 = 1; i_2 < 499; ++i_2) {
        (*B)[(i_0 + 8)][i_1][i_2] = ((*A)[((i_0 + 8) - 1)][(i_1 - 1)][i_2] - (*B)[(i_0 + 8)][i_1][i_2]);
      }
    }
    for (int i_1 = 1; i_1 < 499; ++i_1) {
      for (int i_2 = 1; i_2 < 499; ++i_2) {
        (*B)[(i_0 + 9)][i_1][i_2] = ((*A)[((i_0 + 9) - 1)][(i_1 - 1)][i_2] - (*B)[(i_0 + 9)][i_1][i_2]);
      }
    }
    for (int i_1 = 1; i_1 < 499; ++i_1) {
      for (int i_2 = 1; i_2 < 499; ++i_2) {
        (*B)[(i_0 + 10)][i_1][i_2] = ((*A)[((i_0 + 10) - 1)][(i_1 - 1)][i_2] - (*B)[(i_0 + 10)][i_1][i_2]);
      }
    }
  }
  for (int i_0 = 497; i_0 < 499; ++i_0) {
    for (int i_1 = 1; i_1 < 499; ++i_1) {
      for (int i_2 = 1; i_2 < 499; ++i_2) {
        (*B)[i_0][i_1][i_2] = ((*A)[(i_0 - 1)][(i_1 - 1)][i_2] - (*B)[i_0][i_1][i_2]);
      }
