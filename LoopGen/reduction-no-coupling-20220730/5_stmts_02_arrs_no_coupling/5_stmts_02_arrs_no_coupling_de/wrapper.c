...
void allocate_arrays() {
  ...
  Arr02_ptr = malloc(sizeof(double) * (4194304));
}
...
void init_arrays(double (*restrict Arr01)[4194304], double (*restrict Arr02)[4194304]) {
...
void init_array_ptrs() {
  init_arrays((double(*)[4194304])(Arr01_ptr), (double(*)[4194304])(Arr02_ptr));
}
...
void measure(int n_iterations, int inputs[16]) {
  ...
  for (int i = 0; i < n_iterations; ++i) {
    core((double(*)[4194304])(Arr01_ptr), (double(*)[4194304])(Arr02_ptr));
  }
  measure_stop_();
}
