...
void allocate_heap_vars() {
  ...
  E_ptr = malloc(sizeof(double) * 420 * 420);
}
...
int core(double A[restrict 420][420], double B[restrict 1][1], double C[restrict 1][1], double D[restrict 420][420], double E[restrict 420][420]);
