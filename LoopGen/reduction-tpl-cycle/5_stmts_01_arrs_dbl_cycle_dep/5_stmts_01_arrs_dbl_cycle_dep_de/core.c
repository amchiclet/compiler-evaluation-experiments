...
int core(double (*restrict Arr01)[8388608]) {
  ...
  for (int i = 0; i <= (size - 1) / n_arrs; i += 1) {
    ...
    scalar1 = ((((scalar1 + scalar2) + (*Arr01)[i]) + (*Arr01)[i]) + (*Arr01)[i]) + (*Arr01)[i];
    scalar3 = ((((scalar3 + scalar1) + (*Arr01)[i]) + (*Arr01)[i]) + (*Arr01)[i]) + (*Arr01)[i];
    scalar2 = ((((scalar2 + scalar3) + (*Arr01)[i]) + (*Arr01)[i]) + (*Arr01)[i]) + (*Arr01)[i];
  }
  return 0;
}
