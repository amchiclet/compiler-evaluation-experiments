...
int core(double (*restrict Arr01)[1048576], double (*restrict Arr02)[1048576], double (*restrict Arr03)[1048576], double (*restrict Arr04)[1048576], double (*restrict Arr05)[1048576], double (*restrict Arr06)[1048576], double (*restrict Arr07)[1048576], double (*restrict Arr08)[1048576]) {
  ...
  for (int i = 0; i <= (size - 1) / n_arrs; i += 1) {
    scalar5 = ((((scalar5 + (*Arr01)[i]) + (*Arr02)[i]) + (*Arr03)[i]) + (*Arr05)[i]) + (*Arr07)[i];
    scalar3 = ((((scalar3 + scalar1) + (*Arr08)[i]) + (*Arr06)[i]) + (*Arr04)[i]) + (*Arr01)[i];
    scalar1 = ((((scalar1 + scalar2) + (*Arr08)[i]) + (*Arr08)[i]) + (*Arr07)[i]) + (*Arr06)[i];
    scalar2 = ((((scalar2 + scalar3) + (*Arr03)[i]) + (*Arr04)[i]) + (*Arr07)[i]) + (*Arr05)[i];
    scalar4 = ((((scalar4 + (*Arr01)[i]) + (*Arr03)[i]) + (*Arr03)[i]) + (*Arr05)[i]) + (*Arr06)[i];
  }
  return 0;
}
