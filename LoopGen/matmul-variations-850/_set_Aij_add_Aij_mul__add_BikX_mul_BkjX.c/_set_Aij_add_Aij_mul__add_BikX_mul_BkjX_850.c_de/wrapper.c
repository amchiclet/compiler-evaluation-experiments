...
unsigned long long core(double A[restrict 850][850], double B[restrict 850][850], double C[restrict 1][1], double D[restrict 1][1], double E[restrict 1][1]);
...
int init_inner(double A[restrict 850][850], double B[restrict 850][850], double C[restrict 1][1], double D[restrict 1][1], double E[restrict 1][1]) {
