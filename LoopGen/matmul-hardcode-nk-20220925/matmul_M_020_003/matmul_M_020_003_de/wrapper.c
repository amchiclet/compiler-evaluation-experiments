...
void allocate_arrays() {
  ...
  b_ptr = malloc(sizeof(double) * (3) * (20));
  c_ptr = malloc(sizeof(double) * (10000) * (20));
  d_ptr = malloc(sizeof(double) * (10000) * (20) * (3));
}
...
void init_scalars(int inputs[16]) {
  M = (inputs[0] - 20*3) / (20+3+20*3) /* n=20, k=3*/;
  n_arrs = inputs[1];
  size = inputs[0];
}

void init_arrays(double (*restrict a)[10000][3], double (*restrict b)[3][20], double (*restrict c)[10000][20], double (*restrict d)[10000][20][3]) {
...
void init_array_ptrs() {
  init_arrays((double(*)[10000][3])(a_ptr), (double(*)[3][20])(b_ptr), (double(*)[10000][20])(c_ptr), (double(*)[10000][20][3])(d_ptr));
}
...
void measure(int n_iterations, int inputs[16]) {
  ...
  for (int i = 0; i < n_iterations; ++i) {
    core((double(*)[10000][3])(a_ptr), (double(*)[3][20])(b_ptr), (double(*)[10000][20])(c_ptr), (double(*)[10000][20][3])(d_ptr));
  }
  measure_stop_();
}
