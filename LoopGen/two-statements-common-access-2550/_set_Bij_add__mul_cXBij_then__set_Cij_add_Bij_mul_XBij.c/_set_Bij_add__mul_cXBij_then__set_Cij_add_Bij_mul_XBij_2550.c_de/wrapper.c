...
unsigned long long core(double A[restrict 1][1], double B[restrict 2550][2550], double C[restrict 2550][2550], double D[restrict 1][1], double E[restrict 1][1], double a, double b, double c);
...
int init_inner(double A[restrict 1][1], double B[restrict 2550][2550], double C[restrict 2550][2550], double D[restrict 1][1], double E[restrict 1][1], double a[restrict 1], double b[restrict 1], double c[restrict 1]) {
