...
void allocate_arrays() {
  ...
  v07_ptr = malloc(sizeof(double) * (1));
  v08_ptr = malloc(sizeof(double) * (1));
  v09_ptr = malloc(sizeof(double) * (1));
  v10_ptr = malloc(sizeof(double) * (1));
  v11_ptr = malloc(sizeof(double) * (1));
  v12_ptr = malloc(sizeof(double) * (1));
  v13_ptr = malloc(sizeof(double) * (1));
...
void init_arrays(double v00[restrict 31999], double v01[restrict 31999], double v02[restrict 31999], double v03[restrict 31999], double v04[restrict 31999], double v05[restrict 31999], double v06[restrict 31999], double v07[restrict 1], double v08[restrict 1], double v09[restrict 1], double v10[restrict 1], double v11[restrict 1], double v12[restrict 1], double v13[restrict 1], double v14[restrict 1], double v15[restrict 1], double v16[restrict 1], double v17[restrict 1], double v18[restrict 1], double v19[restrict 1]) {
...
void init_array_ptrs() {
  init_arrays(*(double(*)[31999])(v00_ptr), *(double(*)[31999])(v01_ptr), *(double(*)[31999])(v02_ptr), *(double(*)[31999])(v03_ptr), *(double(*)[31999])(v04_ptr), *(double(*)[31999])(v05_ptr), *(double(*)[31999])(v06_ptr), *(double(*)[1])(v07_ptr), *(double(*)[1])(v08_ptr), *(double(*)[1])(v09_ptr), *(double(*)[1])(v10_ptr), *(double(*)[1])(v11_ptr), *(double(*)[1])(v12_ptr), *(double(*)[1])(v13_ptr), *(double(*)[1])(v14_ptr), *(double(*)[1])(v15_ptr), *(double(*)[1])(v16_ptr), *(double(*)[1])(v17_ptr), *(double(*)[1])(v18_ptr), *(double(*)[1])(v19_ptr));
}
