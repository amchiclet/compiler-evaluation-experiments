...
double (*A_ptr)[1][1];
double (*B_ptr)[1][1];
double (*C_ptr)[2550][2550];
double (*D_ptr)[2550][2550];
double (*E_ptr)[2550][2550];
double a;
double b;
int n;
...
void allocate_heap_vars() {
  ...
  C_ptr = malloc(sizeof(double) * 2550 * 2550);
  D_ptr = malloc(sizeof(double) * 2550 * 2550);
  E_ptr = malloc(sizeof(double) * 2550 * 2550);
}
...
int core(double A[restrict 1][1], double B[restrict 1][1], double C[restrict 2550][2550], double D[restrict 2550][2550], double E[restrict 2550][2550]);
