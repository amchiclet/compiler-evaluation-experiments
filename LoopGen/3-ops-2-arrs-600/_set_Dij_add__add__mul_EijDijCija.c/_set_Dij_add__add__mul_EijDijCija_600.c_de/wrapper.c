...
double (*A_ptr)[1][1];
double (*B_ptr)[1][1];
double (*C_ptr)[600][600];
double (*D_ptr)[600][600];
double (*E_ptr)[600][600];
double a;
double b;
int n;
...
void allocate_heap_vars() {
  ...
  C_ptr = malloc(sizeof(double) * 600 * 600);
  D_ptr = malloc(sizeof(double) * 600 * 600);
  E_ptr = malloc(sizeof(double) * 600 * 600);
}
...
int core(double A[restrict 1][1], double B[restrict 1][1], double C[restrict 600][600], double D[restrict 600][600], double E[restrict 600][600]);
