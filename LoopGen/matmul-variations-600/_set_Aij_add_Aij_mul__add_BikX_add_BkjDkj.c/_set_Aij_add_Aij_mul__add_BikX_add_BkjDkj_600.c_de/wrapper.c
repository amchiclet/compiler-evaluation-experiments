...
unsigned long long core(double A[restrict 600][600], double B[restrict 600][600], double C[restrict 1][1], double D[restrict 600][600], double E[restrict 1][1]);
...
int init_inner(double A[restrict 600][600], double B[restrict 600][600], double C[restrict 1][1], double D[restrict 600][600], double E[restrict 1][1]) {
