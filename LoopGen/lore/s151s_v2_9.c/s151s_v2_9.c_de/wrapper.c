...
void allocate_arrays() {
  ...
  e_ptr = malloc(sizeof(double) * (1) * (9) * (32000));
}
...
void init_arrays(double a[restrict 1][32000], double b[restrict 1][32000], double e[restrict 1][9][32000]) {
...
void init_array_ptrs() {
  init_arrays(*(double(*)[1][32000])(a_ptr), *(double(*)[1][32000])(b_ptr), *(double(*)[1][9][32000])(e_ptr));
}
...
void measure(int n_iterations, int n_elements) {
  ...
  for (int i = 0; i < n_iterations; ++i) {
    core(*(double(*)[1][32000])(a_ptr), *(double(*)[1][32000])(b_ptr), *(double(*)[1][9][32000])(e_ptr));
  }
  measure_stop_();
}
