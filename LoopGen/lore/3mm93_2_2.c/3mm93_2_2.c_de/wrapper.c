...
void allocate_arrays() {
  ...
  F3_ptr = malloc(sizeof(double) * (1) * (1));
  F4_ptr = malloc(sizeof(double) * (1) * (1));
  F5_ptr = malloc(sizeof(double) * (1) * (1));
