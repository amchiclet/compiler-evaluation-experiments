...
void allocate_arrays() {
  ...
  Dex12_ptr = malloc(sizeof(double) * (1));
  Ex1_ptr = malloc(sizeof(double) * (1001));
  Ex12_ptr = malloc(sizeof(double) * (1));
  ...
  Vx2_ptr = malloc(sizeof(double) * (1));
  Xi_ptr = malloc(sizeof(double) * (1001));
  Xi2_ptr = malloc(sizeof(double) * (1));
...
void init_arrays(double Dex1[restrict 1001], double Dex12[restrict 1], double Ex1[restrict 1001], double Ex12[restrict 1], int Ir[restrict 1001], int Ir2[restrict 1001], double Rx[restrict 1001], double Rx2[restrict 1001], double Vx[restrict 1001], double Vx2[restrict 1], double Xi[restrict 1001], double Xi2[restrict 1], double Xtra[restrict 40], double Xtra2[restrict 1], double Xx[restrict 1001], double Xx2[restrict 1001]) {
...
void init_array_ptrs() {
  init_arrays(*(double(*)[1001])(Dex1_ptr), *(double(*)[1])(Dex12_ptr), *(double(*)[1001])(Ex1_ptr), *(double(*)[1])(Ex12_ptr), *(int(*)[1001])(Ir_ptr), *(int(*)[1001])(Ir2_ptr), *(double(*)[1001])(Rx_ptr), *(double(*)[1001])(Rx2_ptr), *(double(*)[1001])(Vx_ptr), *(double(*)[1])(Vx2_ptr), *(double(*)[1001])(Xi_ptr), *(double(*)[1])(Xi2_ptr), *(double(*)[40])(Xtra_ptr), *(double(*)[1])(Xtra2_ptr), *(double(*)[1001])(Xx_ptr), *(double(*)[1001])(Xx2_ptr));
}
