...
void init_arrays(double A[restrict 1], double B[restrict 1], double C[restrict 92700], double mormult[restrict 92700], double tmort[restrict 92700]) {
...
void init_array_ptrs() {
  init_arrays(*(double(*)[1])(A_ptr), *(double(*)[1])(B_ptr), *(double(*)[92700])(C_ptr), *(double(*)[92700])(mormult_ptr), *(double(*)[92700])(tmort_ptr));
}
...
void measure(int n_iterations, int n_elements) {
  ...
  for (int i = 0; i < n_iterations; ++i) {
    core(*(double(*)[1])(A_ptr), *(double(*)[1])(B_ptr), *(double(*)[92700])(C_ptr), *(double(*)[92700])(mormult_ptr), *(double(*)[92700])(tmort_ptr));
  }
  measure_stop_();
}
