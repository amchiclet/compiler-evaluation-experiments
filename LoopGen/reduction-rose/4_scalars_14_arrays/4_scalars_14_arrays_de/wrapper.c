...
void init_arrays(double (*restrict Arr01)[32000], double (*restrict Arr02)[32000], double (*restrict Arr03)[32000], double (*restrict Arr04)[32000], double (*restrict Arr05)[1], double (*restrict Arr06)[32000], double (*restrict Arr07)[32000], double (*restrict Arr08)[1], double (*restrict Arr09)[32000], double (*restrict Arr10)[1], double (*restrict Arr11)[32000], double (*restrict Arr12)[32000], double (*restrict Arr13)[32000], double (*restrict Arr14)[32000], double (*restrict Arr15)[1], double (*restrict Arr16)[1], double (*restrict Arr17)[1], double (*restrict Arr18)[1], double (*restrict Arr19)[1], double (*restrict Arr20)[1], double (*restrict Arr21)[1], double (*restrict Arr22)[1], double (*restrict Arr23)[1], double (*restrict Arr24)[1], double (*restrict Arr25)[1]) {
...
void measure(int n_iterations, int inputs[16]) {
  ...
  for (int i = 0; i < n_iterations; ++i) {
    core((double(*)[32000])(Arr01_ptr), (double(*)[32000])(Arr02_ptr), (double(*)[32000])(Arr03_ptr), (double(*)[32000])(Arr04_ptr), (double(*)[1])(Arr05_ptr), (double(*)[32000])(Arr06_ptr), (double(*)[32000])(Arr07_ptr), (double(*)[1])(Arr08_ptr), (double(*)[32000])(Arr09_ptr), (double(*)[1])(Arr10_ptr), (double(*)[32000])(Arr11_ptr), (double(*)[32000])(Arr12_ptr), (double(*)[32000])(Arr13_ptr), (double(*)[32000])(Arr14_ptr), (double(*)[1])(Arr15_ptr), (double(*)[1])(Arr16_ptr), (double(*)[1])(Arr17_ptr), (double(*)[1])(Arr18_ptr), (double(*)[1])(Arr19_ptr), (double(*)[1])(Arr20_ptr), (double(*)[1])(Arr21_ptr), (double(*)[1])(Arr22_ptr), (double(*)[1])(Arr23_ptr), (double(*)[1])(Arr24_ptr), (double(*)[1])(Arr25_ptr));
  }
  measure_stop_();
}
