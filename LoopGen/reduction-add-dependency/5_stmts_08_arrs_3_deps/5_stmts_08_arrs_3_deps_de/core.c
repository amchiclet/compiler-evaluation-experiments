...
int core(double (*restrict Arr01)[1048576], double (*restrict Arr02)[1048576], double (*restrict Arr03)[1048576], double (*restrict Arr04)[1048576], double (*restrict Arr05)[1048576], double (*restrict Arr06)[1048576], double (*restrict Arr07)[1048576], double (*restrict Arr08)[1048576]) {
  ...
  for (int i = 0; i <= (size - 1) / n_arrs; i += 1) {
    scalar2 = ((((scalar2 + scalar5) + (*Arr05)[i]) + (*Arr03)[i]) + (*Arr08)[i]) + (*Arr06)[i];
    scalar1 = ((((scalar1 + scalar2) + (*Arr01)[i]) + (*Arr07)[i]) + (*Arr02)[i]) + (*Arr04)[i];
    scalar3 = ((((scalar3 + scalar5) + (*Arr02)[i]) + (*Arr06)[i]) + (*Arr05)[i]) + (*Arr03)[i];
    scalar4 = ((((scalar4 + (*Arr08)[i]) + (*Arr04)[i]) + (*Arr06)[i]) + (*Arr03)[i]) + (*Arr07)[i];
    scalar5 = ((((scalar5 + (*Arr06)[i]) + (*Arr05)[i]) + (*Arr08)[i]) + (*Arr07)[i]) + (*Arr01)[i];
  }
  return 0;
}
