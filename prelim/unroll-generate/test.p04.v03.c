...
clock_t kernel() {
  ...
  for (int i_0 = 1; i_0 < 499; ++i_0) {
    ...
    for (int i_1 = 4; i_1 < 499; i_1+=15) {
      for (int i_2 = 1; i_2 < 499; ++i_2) {
        (*C)[i_0][(i_1 + 0)][i_2] = ((*B)[i_0][(i_1 + 0)][i_2] - (*C)[i_0][((i_1 + 0) - 1)][i_2]);
      }
      for (int i_2 = 1; i_2 < 499; ++i_2) {
        (*C)[i_0][(i_1 + 1)][i_2] = ((*B)[i_0][(i_1 + 1)][i_2] - (*C)[i_0][((i_1 + 1) - 1)][i_2]);
      }
      for (int i_2 = 1; i_2 < 499; ++i_2) {
        (*C)[i_0][(i_1 + 2)][i_2] = ((*B)[i_0][(i_1 + 2)][i_2] - (*C)[i_0][((i_1 + 2) - 1)][i_2]);
      }
      for (int i_2 = 1; i_2 < 499; ++i_2) {
        (*C)[i_0][(i_1 + 3)][i_2] = ((*B)[i_0][(i_1 + 3)][i_2] - (*C)[i_0][((i_1 + 3) - 1)][i_2]);
      }
      for (int i_2 = 1; i_2 < 499; ++i_2) {
        (*C)[i_0][(i_1 + 4)][i_2] = ((*B)[i_0][(i_1 + 4)][i_2] - (*C)[i_0][((i_1 + 4) - 1)][i_2]);
      }
      for (int i_2 = 1; i_2 < 499; ++i_2) {
        (*C)[i_0][(i_1 + 5)][i_2] = ((*B)[i_0][(i_1 + 5)][i_2] - (*C)[i_0][((i_1 + 5) - 1)][i_2]);
      }
      for (int i_2 = 1; i_2 < 499; ++i_2) {
        (*C)[i_0][(i_1 + 6)][i_2] = ((*B)[i_0][(i_1 + 6)][i_2] - (*C)[i_0][((i_1 + 6) - 1)][i_2]);
      }
      for (int i_2 = 1; i_2 < 499; ++i_2) {
        (*C)[i_0][(i_1 + 7)][i_2] = ((*B)[i_0][(i_1 + 7)][i_2] - (*C)[i_0][((i_1 + 7) - 1)][i_2]);
      }
      for (int i_2 = 1; i_2 < 499; ++i_2) {
        (*C)[i_0][(i_1 + 8)][i_2] = ((*B)[i_0][(i_1 + 8)][i_2] - (*C)[i_0][((i_1 + 8) - 1)][i_2]);
      }
      for (int i_2 = 1; i_2 < 499; ++i_2) {
        (*C)[i_0][(i_1 + 9)][i_2] = ((*B)[i_0][(i_1 + 9)][i_2] - (*C)[i_0][((i_1 + 9) - 1)][i_2]);
      }
      for (int i_2 = 1; i_2 < 499; ++i_2) {
        (*C)[i_0][(i_1 + 10)][i_2] = ((*B)[i_0][(i_1 + 10)][i_2] - (*C)[i_0][((i_1 + 10) - 1)][i_2]);
      }
      for (int i_2 = 1; i_2 < 499; ++i_2) {
        (*C)[i_0][(i_1 + 11)][i_2] = ((*B)[i_0][(i_1 + 11)][i_2] - (*C)[i_0][((i_1 + 11) - 1)][i_2]);
      }
      for (int i_2 = 1; i_2 < 499; ++i_2) {
        (*C)[i_0][(i_1 + 12)][i_2] = ((*B)[i_0][(i_1 + 12)][i_2] - (*C)[i_0][((i_1 + 12) - 1)][i_2]);
      }
      for (int i_2 = 1; i_2 < 499; ++i_2) {
        (*C)[i_0][(i_1 + 13)][i_2] = ((*B)[i_0][(i_1 + 13)][i_2] - (*C)[i_0][((i_1 + 13) - 1)][i_2]);
      }
      for (int i_2 = 1; i_2 < 499; ++i_2) {
        (*C)[i_0][(i_1 + 14)][i_2] = ((*B)[i_0][(i_1 + 14)][i_2] - (*C)[i_0][((i_1 + 14) - 1)][i_2]);
      }
    }
  }
  clock_t after = clock();
