  ...
  for (int i_0 = 1; i_0 < 499; ++i_0) {
    ...
    for (int i_1 = 1; i_1 < 499; ++i_1) {
      ...
      for (int i_2 = 1; i_2 < 499; ++i_2) {
        (*B)[((iv_0 - 26) / 23)][((iv_1 - 10) / 5)][((iv_2 - 22) / 53)] = ((*C)[(((iv_1 - 10) / 5) + 1)][(i_0 - 1)][((iv_2 - 22) / 53)] + (*B)[i_0][(((iv_1 - 10) / 5) - 1)][((iv_2 - 22) / 53)]);
        iv_2 = (iv_2 + 53);
      }
      iv_1 = (iv_1 + 5);
    }
...
void check() {
  ...
  for (int i_0 = 1; i_0 < 499; ++i_0) {
    for (int i_1 = 1; i_1 < 499; ++i_1) {
      for (int i_2 = 1; i_2 < 499; ++i_2) {
        (*Btest)[i_0][i_1][i_2] = ((*Ctest)[(i_1 + 1)][(i_0 - 1)][i_2] + (*Btest)[i_0][(i_1 - 1)][i_2]);
      }
    }
  }
  int pass = 1;
