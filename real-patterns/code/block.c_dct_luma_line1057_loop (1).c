...
typedef enum FALSE_enum Boolean;
...
#pragma scop
    ...
    for(i = 0; i < 4; i++)
    {
        ...
        {
            img -> m7[0][i] =(((img -> max_imgpel_value) <((0 >(m6[0] + m6[3]) +(((long )img -> mpr[0 + block_y][ii]) << 6) +(1 << 6 - 1) >> 6?0 :(m6[0] + m6[3]) +(((long )img -> mpr[0 + block_y][ii]) << 6) +(1 << 6 - 1) >> 6))?(img -> max_imgpel_value) :((0 >(m6[0] + m6[3]) +(((long )img -> mpr[0 + block_y][ii]) << 6) +(1 << 6 - 1) >> 6?0 :(m6[0] + m6[3]) +(((long )img -> mpr[0 + block_y][ii]) << 6) +(1 << 6 - 1) >> 6))));
            img -> m7[1][i] =(((img -> max_imgpel_value) <((0 >(m6[1] + m6[2]) +(((long )img -> mpr[1 + block_y][ii]) << 6) +(1 << 6 - 1) >> 6?0 :(m6[1] + m6[2]) +(((long )img -> mpr[1 + block_y][ii]) << 6) +(1 << 6 - 1) >> 6))?(img -> max_imgpel_value) :((0 >(m6[1] + m6[2]) +(((long )img -> mpr[1 + block_y][ii]) << 6) +(1 << 6 - 1) >> 6?0 :(m6[1] + m6[2]) +(((long )img -> mpr[1 + block_y][ii]) << 6) +(1 << 6 - 1) >> 6))));
            img -> m7[2][i] =(((img -> max_imgpel_value) <((0 >(m6[1] - m6[2]) +(((long )img -> mpr[2 + block_y][ii]) << 6) +(1 << 6 - 1) >> 6?0 :(m6[1] - m6[2]) +(((long )img -> mpr[2 + block_y][ii]) << 6) +(1 << 6 - 1) >> 6))?(img -> max_imgpel_value) :((0 >(m6[1] - m6[2]) +(((long )img -> mpr[2 + block_y][ii]) << 6) +(1 << 6 - 1) >> 6?0 :(m6[1] - m6[2]) +(((long )img -> mpr[2 + block_y][ii]) << 6) +(1 << 6 - 1) >> 6))));
            img -> m7[3][i] =(((img -> max_imgpel_value) <((0 >(m6[0] - m6[3]) +(((long )img -> mpr[3 + block_y][ii]) << 6) +(1 << 6 - 1) >> 6?0 :(m6[0] - m6[3]) +(((long )img -> mpr[3 + block_y][ii]) << 6) +(1 << 6 - 1) >> 6))?(img -> max_imgpel_value) :((0 >(m6[0] - m6[3]) +(((long )img -> mpr[3 + block_y][ii]) << 6) +(1 << 6 - 1) >> 6?0 :(m6[0] - m6[3]) +(((long )img -> mpr[3 + block_y][ii]) << 6) +(1 << 6 - 1) >> 6))));
        }
        else
        {
            if(lossless_qpprime)
            ...
            {
                img -> m7[0][i] = m6[0] + m6[3] +(1 << 6 - 1) >> 6;
                img -> m7[1][i] = m6[1] + m6[2] +(1 << 6 - 1) >> 6;
                img -> m7[2][i] = m6[1] - m6[2] +(1 << 6 - 1) >> 6;
                img -> m7[3][i] = m6[0] - m6[3] +(1 << 6 - 1) >> 6;
            }
        }
    }
