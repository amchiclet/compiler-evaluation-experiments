...
extern unsigned short ** restrict imgY_orig;
extern int pic_opix_y;
extern unsigned short ** restrict imgY;
...
#pragma scop
    ...
    for(y = 0; y < 8; y++) for(x = pic_pix_x; x < pic_pix_x + 8; x++) distortion += img -> quad[imgY_orig[pic_opix_y + y][x] - imgY[pic_pix_y + y][x]];
