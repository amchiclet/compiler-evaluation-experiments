            ...
            {
                {
                    ...
                    for(l = 0; l < 5; l++)
                    {
                        rhs[i][j][k][l] = rhs[i][j][k][l] - lhs[i][j][k][0][l][0] * rhs[i][j - 1][k][0] - lhs[i][j][k][0][l][1] * rhs[i][j - 1][k][1] - lhs[i][j][k][0][l][2] * rhs[i][j - 1][k][2] - lhs[i][j][k][0][l][3] * rhs[i][j - 1][k][3] - lhs[i][j][k][0][l][4] * rhs[i][j - 1][k][4];
                    }
                };
                {
                    int l;
                    for(l = 0; l < 5; l++)
                    {
                        lhs[i][j][k][1][0][l] = lhs[i][j][k][1][0][l] - lhs[i][j][k][0][0][0] * lhs[i][j - 1][k][2][0][l] - lhs[i][j][k][0][0][1] * lhs[i][j - 1][k][2][1][l] - lhs[i][j][k][0][0][2] * lhs[i][j - 1][k][2][2][l] - lhs[i][j][k][0][0][3] * lhs[i][j - 1][k][2][3][l] - lhs[i][j][k][0][0][4] * lhs[i][j - 1][k][2][4][l];
                        lhs[i][j][k][1][1][l] = lhs[i][j][k][1][1][l] - lhs[i][j][k][0][1][0] * lhs[i][j - 1][k][2][0][l] - lhs[i][j][k][0][1][1] * lhs[i][j - 1][k][2][1][l] - lhs[i][j][k][0][1][2] * lhs[i][j - 1][k][2][2][l] - lhs[i][j][k][0][1][3] * lhs[i][j - 1][k][2][3][l] - lhs[i][j][k][0][1][4] * lhs[i][j - 1][k][2][4][l];
                        lhs[i][j][k][1][2][l] = lhs[i][j][k][1][2][l] - lhs[i][j][k][0][2][0] * lhs[i][j - 1][k][2][0][l] - lhs[i][j][k][0][2][1] * lhs[i][j - 1][k][2][1][l] - lhs[i][j][k][0][2][2] * lhs[i][j - 1][k][2][2][l] - lhs[i][j][k][0][2][3] * lhs[i][j - 1][k][2][3][l] - lhs[i][j][k][0][2][4] * lhs[i][j - 1][k][2][4][l];
                        lhs[i][j][k][1][3][l] = lhs[i][j][k][1][3][l] - lhs[i][j][k][0][3][0] * lhs[i][j - 1][k][2][0][l] - lhs[i][j][k][0][3][1] * lhs[i][j - 1][k][2][1][l] - lhs[i][j][k][0][3][2] * lhs[i][j - 1][k][2][2][l] - lhs[i][j][k][0][3][3] * lhs[i][j - 1][k][2][3][l] - lhs[i][j][k][0][3][4] * lhs[i][j - 1][k][2][4][l];
                        lhs[i][j][k][1][4][l] = lhs[i][j][k][1][4][l] - lhs[i][j][k][0][4][0] * lhs[i][j - 1][k][2][0][l] - lhs[i][j][k][0][4][1] * lhs[i][j - 1][k][2][1][l] - lhs[i][j][k][0][4][2] * lhs[i][j - 1][k][2][2][l] - lhs[i][j][k][0][4][3] * lhs[i][j - 1][k][2][3][l] - lhs[i][j][k][0][4][4] * lhs[i][j - 1][k][2][4][l];
                    }
                };
                {
                    static double pivot;
