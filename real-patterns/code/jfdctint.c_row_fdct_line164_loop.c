...
#pragma scop
    ...
    for(ctr = 8 - 1; ctr >= 0; ctr--)
    {
        ...
        tmp11 = tmp1 + tmp2;
        tmp12 = tmp1 - tmp2;
        dataptr[0] =((DCTELEM )(tmp10 + tmp11 << 4));
        dataptr[4] =((DCTELEM )(tmp10 - tmp11 << 4));
        z1 =(tmp12 + tmp13) *((int32_t )4433);
        dataptr[2] =((DCTELEM )(z1 + tmp13 *((int32_t )6270) +(1 << 13 - 4 - 1) >> 13 - 4));
        dataptr[6] =((DCTELEM )(z1 + tmp12 *(-((int32_t )15137)) +(1 << 13 - 4 - 1) >> 13 - 4));
        z1 = tmp4 + tmp7;
        z2 = tmp5 + tmp6;
        z3 = tmp4 + tmp6;
        z4 = tmp5 + tmp7;
        ...
        z3 += z5;
        z4 += z5;
        dataptr[7] =((DCTELEM )(tmp4 + z1 + z3 +(1 << 13 - 4 - 1) >> 13 - 4));
        dataptr[5] =((DCTELEM )(tmp5 + z2 + z4 +(1 << 13 - 4 - 1) >> 13 - 4));
        dataptr[3] =((DCTELEM )(tmp6 + z2 + z3 +(1 << 13 - 4 - 1) >> 13 - 4));
        dataptr[1] =((DCTELEM )(tmp7 + z1 + z4 +(1 << 13 - 4 - 1) >> 13 - 4));
        dataptr += 8;
    }
