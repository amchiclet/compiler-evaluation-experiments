  ...
  for (int i_0 = 1; i_0 < 499; ++i_0) {
    ...
    for (int i_1 = 1; i_1 < 499; ++i_1) {
      ...
      for (int i_2 = 1; i_2 < 499; ++i_2) {
        (*A)[((iv_0 - 28) / 25)][iv_1][((iv_2 - 20) / 24)] = ((*C)[(i_1 + 1)][(((iv_0 - 28) / 25) + 1)][((iv_2 - 20) / 24)] + (*A)[(((iv_0 - 28) / 25) + 1)][(i_1 - 1)][((iv_2 - 20) / 24)]);
        iv_2 = (iv_2 + 24);
      }
    }
    iv_0 = (iv_0 + 25);
...
void check() {
  ...
  for (int i_0 = 1; i_0 < 499; ++i_0) {
    for (int i_1 = 1; i_1 < 499; ++i_1) {
      for (int i_2 = 1; i_2 < 499; ++i_2) {
        (*Atest)[i_0][i_1][i_2] = ((*Ctest)[(i_1 + 1)][(i_0 + 1)][i_2] + (*Atest)[(i_0 + 1)][(i_1 - 1)][i_2]);
      }
    }
  }
  int pass = 1;
