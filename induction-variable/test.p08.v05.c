  ...
  for (int i_0 = 1; i_0 < 499; ++i_0) {
    ...
    for (int i_1 = 1; i_1 < 499; ++i_1) {
      ...
      for (int i_2 = 1; i_2 < 499; ++i_2) {
        (*A)[((iv_0 - 19) / 55)][((iv_1 - 31) / 51)][((iv_2 - 10) / 25)] = ((*A)[((iv_0 - 19) / 55)][(((iv_1 - 31) / 51) + 1)][((iv_2 - 10) / 25)] * (*B)[(((iv_1 - 31) / 51) - 1)][i_0][((iv_2 - 10) / 25)]);
        iv_2 = (iv_2 + 25);
      }
      iv_1 = (iv_1 + 51);
    }
...
void check() {
  ...
  for (int i_0 = 1; i_0 < 499; ++i_0) {
    for (int i_1 = 1; i_1 < 499; ++i_1) {
      for (int i_2 = 1; i_2 < 499; ++i_2) {
        (*Atest)[i_0][i_1][i_2] = ((*Atest)[i_0][(i_1 + 1)][i_2] * (*Btest)[(i_1 - 1)][i_0][i_2]);
      }
    }
  }
  int pass = 1;
