  ...
  for (int i_0 = 1; i_0 < 499; ++i_0) {
    ...
    for (int i_1 = 1; i_1 < 499; ++i_1) {
      ...
      for (int i_2 = 1; i_2 < 499; ++i_2) {
        (*C)[((iv_0 - 16) / 14)][((iv_1 - 19) / 33)][((iv_2 - 25) / 33)] = ((*A)[(((iv_0 - 16) / 14) - 1)][((iv_1 - 19) / 33)][i_2] + (*B)[(((iv_1 - 19) / 33) - 1)][(((iv_0 - 16) / 14) + 1)][((iv_2 - 25) / 33)]);
        iv_2 = (iv_2 + 33);
      }
      iv_1 = (iv_1 + 33);
    }
...
void check() {
  ...
  for (int i_0 = 1; i_0 < 499; ++i_0) {
    for (int i_1 = 1; i_1 < 499; ++i_1) {
      for (int i_2 = 1; i_2 < 499; ++i_2) {
        (*Ctest)[i_0][i_1][i_2] = ((*Atest)[(i_0 - 1)][i_1][i_2] + (*Btest)[(i_1 - 1)][(i_0 + 1)][i_2]);
      }
    }
  }
  int pass = 1;
