...
def gen_program(n_arrs):
    stmts = [
        Mapping(
            ...
            ['scalar1 = scalar1 + scalar2 + #_# + #_# + #_# + #_#;',
             ...
             'scalar3 = scalar3 + #_:except3# + #_# + #_# + #_# + #_#;',
    ...
    except_exprs = [
        Mapping('except3', ['scalar1', 'scalar2', 'scalar4', 'scalar5']),
    ]
    initial_exprs = [
        Mapping(
            '_',
    ...
    program = program.fill_expressions(except_exprs)
...
seed(0)
application = 'LoopGen'
batch = 'reduction-dbl-cycle-and-extra-dep'

programs = set()
source_infos = []
for n_arrs in range(1, 21):
    skeleton = gen_program(n_arrs)
    code = f'5_stmts_{n_arrs:02d}_arrs_dbl_cycle_and_1_extra_dep'
    codelet = f'{code}_de'
    ...
    si.extra_columns.append(3) # additional deps
