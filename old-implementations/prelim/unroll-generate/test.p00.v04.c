...
clock_t kernel() {
  ...
  for (int i_0 = 1; i_0 < 499; ++i_0) {
    for (int i_1 = 1; i_1 < 499; ++i_1) {
      ...
      for (int i_2 = 7; i_2 < 499; i_2+=12) {
        (*C)[i_0][i_1][(i_2 + 0)] = ((*C)[(i_0 + 1)][(i_1 - 1)][(i_2 + 0)] * (*B)[(i_1 - 1)][(i_0 - 1)][(i_2 + 0)]);
        (*C)[i_0][i_1][(i_2 + 1)] = ((*C)[(i_0 + 1)][(i_1 - 1)][(i_2 + 1)] * (*B)[(i_1 - 1)][(i_0 - 1)][(i_2 + 1)]);
        (*C)[i_0][i_1][(i_2 + 2)] = ((*C)[(i_0 + 1)][(i_1 - 1)][(i_2 + 2)] * (*B)[(i_1 - 1)][(i_0 - 1)][(i_2 + 2)]);
        (*C)[i_0][i_1][(i_2 + 3)] = ((*C)[(i_0 + 1)][(i_1 - 1)][(i_2 + 3)] * (*B)[(i_1 - 1)][(i_0 - 1)][(i_2 + 3)]);
        (*C)[i_0][i_1][(i_2 + 4)] = ((*C)[(i_0 + 1)][(i_1 - 1)][(i_2 + 4)] * (*B)[(i_1 - 1)][(i_0 - 1)][(i_2 + 4)]);
        (*C)[i_0][i_1][(i_2 + 5)] = ((*C)[(i_0 + 1)][(i_1 - 1)][(i_2 + 5)] * (*B)[(i_1 - 1)][(i_0 - 1)][(i_2 + 5)]);
        (*C)[i_0][i_1][(i_2 + 6)] = ((*C)[(i_0 + 1)][(i_1 - 1)][(i_2 + 6)] * (*B)[(i_1 - 1)][(i_0 - 1)][(i_2 + 6)]);
        (*C)[i_0][i_1][(i_2 + 7)] = ((*C)[(i_0 + 1)][(i_1 - 1)][(i_2 + 7)] * (*B)[(i_1 - 1)][(i_0 - 1)][(i_2 + 7)]);
        (*C)[i_0][i_1][(i_2 + 8)] = ((*C)[(i_0 + 1)][(i_1 - 1)][(i_2 + 8)] * (*B)[(i_1 - 1)][(i_0 - 1)][(i_2 + 8)]);
        (*C)[i_0][i_1][(i_2 + 9)] = ((*C)[(i_0 + 1)][(i_1 - 1)][(i_2 + 9)] * (*B)[(i_1 - 1)][(i_0 - 1)][(i_2 + 9)]);
        (*C)[i_0][i_1][(i_2 + 10)] = ((*C)[(i_0 + 1)][(i_1 - 1)][(i_2 + 10)] * (*B)[(i_1 - 1)][(i_0 - 1)][(i_2 + 10)]);
        (*C)[i_0][i_1][(i_2 + 11)] = ((*C)[(i_0 + 1)][(i_1 - 1)][(i_2 + 11)] * (*B)[(i_1 - 1)][(i_0 - 1)][(i_2 + 11)]);
      }
    }
  }
  clock_t after = clock();
