...
clock_t kernel() {
  ...
  for (int i_0 = 1; i_0 < 2; ++i_0) {
    for (int i_1 = 1; i_1 < 499; ++i_1) {
      for (int i_2 = 1; i_2 < 499; ++i_2) {
        (*C)[i_0][i_1][i_2] = ((*B)[i_0][i_1][i_2] - (*C)[i_0][(i_1 - 1)][i_2]);
      }
    }
  }
  for (int i_0 = 2; i_0 < 482; i_0+=30) {
    for (int i_1 = 1; i_1 < 499; ++i_1) {
      for (int i_2 = 1; i_2 < 499; ++i_2) {
        (*C)[(i_0 + 0)][i_1][i_2] = ((*B)[(i_0 + 0)][i_1][i_2] - (*C)[(i_0 + 0)][(i_1 - 1)][i_2]);
      }
    }
    for (int i_1 = 1; i_1 < 499; ++i_1) {
      for (int i_2 = 1; i_2 < 499; ++i_2) {
        (*C)[(i_0 + 1)][i_1][i_2] = ((*B)[(i_0 + 1)][i_1][i_2] - (*C)[(i_0 + 1)][(i_1 - 1)][i_2]);
      }
    }
    for (int i_1 = 1; i_1 < 499; ++i_1) {
      for (int i_2 = 1; i_2 < 499; ++i_2) {
        (*C)[(i_0 + 2)][i_1][i_2] = ((*B)[(i_0 + 2)][i_1][i_2] - (*C)[(i_0 + 2)][(i_1 - 1)][i_2]);
      }
    }
    for (int i_1 = 1; i_1 < 499; ++i_1) {
      for (int i_2 = 1; i_2 < 499; ++i_2) {
        (*C)[(i_0 + 3)][i_1][i_2] = ((*B)[(i_0 + 3)][i_1][i_2] - (*C)[(i_0 + 3)][(i_1 - 1)][i_2]);
      }
    }
    for (int i_1 = 1; i_1 < 499; ++i_1) {
      for (int i_2 = 1; i_2 < 499; ++i_2) {
        (*C)[(i_0 + 4)][i_1][i_2] = ((*B)[(i_0 + 4)][i_1][i_2] - (*C)[(i_0 + 4)][(i_1 - 1)][i_2]);
      }
    }
    for (int i_1 = 1; i_1 < 499; ++i_1) {
      for (int i_2 = 1; i_2 < 499; ++i_2) {
        (*C)[(i_0 + 5)][i_1][i_2] = ((*B)[(i_0 + 5)][i_1][i_2] - (*C)[(i_0 + 5)][(i_1 - 1)][i_2]);
      }
    }
    for (int i_1 = 1; i_1 < 499; ++i_1) {
      for (int i_2 = 1; i_2 < 499; ++i_2) {
        (*C)[(i_0 + 6)][i_1][i_2] = ((*B)[(i_0 + 6)][i_1][i_2] - (*C)[(i_0 + 6)][(i_1 - 1)][i_2]);
      }
    }
    for (int i_1 = 1; i_1 < 499; ++i_1) {
      for (int i_2 = 1; i_2 < 499; ++i_2) {
        (*C)[(i_0 + 7)][i_1][i_2] = ((*B)[(i_0 + 7)][i_1][i_2] - (*C)[(i_0 + 7)][(i_1 - 1)][i_2]);
      }
    }
    for (int i_1 = 1; i_1 < 499; ++i_1) {
      for (int i_2 = 1; i_2 < 499; ++i_2) {
        (*C)[(i_0 + 8)][i_1][i_2] = ((*B)[(i_0 + 8)][i_1][i_2] - (*C)[(i_0 + 8)][(i_1 - 1)][i_2]);
      }
    }
    for (int i_1 = 1; i_1 < 499; ++i_1) {
      for (int i_2 = 1; i_2 < 499; ++i_2) {
        (*C)[(i_0 + 9)][i_1][i_2] = ((*B)[(i_0 + 9)][i_1][i_2] - (*C)[(i_0 + 9)][(i_1 - 1)][i_2]);
      }
    }
    for (int i_1 = 1; i_1 < 499; ++i_1) {
      for (int i_2 = 1; i_2 < 499; ++i_2) {
        (*C)[(i_0 + 10)][i_1][i_2] = ((*B)[(i_0 + 10)][i_1][i_2] - (*C)[(i_0 + 10)][(i_1 - 1)][i_2]);
      }
    }
    for (int i_1 = 1; i_1 < 499; ++i_1) {
      for (int i_2 = 1; i_2 < 499; ++i_2) {
        (*C)[(i_0 + 11)][i_1][i_2] = ((*B)[(i_0 + 11)][i_1][i_2] - (*C)[(i_0 + 11)][(i_1 - 1)][i_2]);
      }
    }
    for (int i_1 = 1; i_1 < 499; ++i_1) {
      for (int i_2 = 1; i_2 < 499; ++i_2) {
        (*C)[(i_0 + 12)][i_1][i_2] = ((*B)[(i_0 + 12)][i_1][i_2] - (*C)[(i_0 + 12)][(i_1 - 1)][i_2]);
      }
    }
    for (int i_1 = 1; i_1 < 499; ++i_1) {
      for (int i_2 = 1; i_2 < 499; ++i_2) {
        (*C)[(i_0 + 13)][i_1][i_2] = ((*B)[(i_0 + 13)][i_1][i_2] - (*C)[(i_0 + 13)][(i_1 - 1)][i_2]);
      }
    }
    for (int i_1 = 1; i_1 < 499; ++i_1) {
      for (int i_2 = 1; i_2 < 499; ++i_2) {
        (*C)[(i_0 + 14)][i_1][i_2] = ((*B)[(i_0 + 14)][i_1][i_2] - (*C)[(i_0 + 14)][(i_1 - 1)][i_2]);
      }
    }
    for (int i_1 = 1; i_1 < 499; ++i_1) {
      for (int i_2 = 1; i_2 < 499; ++i_2) {
        (*C)[(i_0 + 15)][i_1][i_2] = ((*B)[(i_0 + 15)][i_1][i_2] - (*C)[(i_0 + 15)][(i_1 - 1)][i_2]);
      }
    }
    for (int i_1 = 1; i_1 < 499; ++i_1) {
      for (int i_2 = 1; i_2 < 499; ++i_2) {
        (*C)[(i_0 + 16)][i_1][i_2] = ((*B)[(i_0 + 16)][i_1][i_2] - (*C)[(i_0 + 16)][(i_1 - 1)][i_2]);
      }
    }
    for (int i_1 = 1; i_1 < 499; ++i_1) {
      for (int i_2 = 1; i_2 < 499; ++i_2) {
        (*C)[(i_0 + 17)][i_1][i_2] = ((*B)[(i_0 + 17)][i_1][i_2] - (*C)[(i_0 + 17)][(i_1 - 1)][i_2]);
      }
    }
    for (int i_1 = 1; i_1 < 499; ++i_1) {
      for (int i_2 = 1; i_2 < 499; ++i_2) {
        (*C)[(i_0 + 18)][i_1][i_2] = ((*B)[(i_0 + 18)][i_1][i_2] - (*C)[(i_0 + 18)][(i_1 - 1)][i_2]);
      }
    }
    for (int i_1 = 1; i_1 < 499; ++i_1) {
      for (int i_2 = 1; i_2 < 499; ++i_2) {
        (*C)[(i_0 + 19)][i_1][i_2] = ((*B)[(i_0 + 19)][i_1][i_2] - (*C)[(i_0 + 19)][(i_1 - 1)][i_2]);
      }
    }
    for (int i_1 = 1; i_1 < 499; ++i_1) {
      for (int i_2 = 1; i_2 < 499; ++i_2) {
        (*C)[(i_0 + 20)][i_1][i_2] = ((*B)[(i_0 + 20)][i_1][i_2] - (*C)[(i_0 + 20)][(i_1 - 1)][i_2]);
      }
    }
    for (int i_1 = 1; i_1 < 499; ++i_1) {
      for (int i_2 = 1; i_2 < 499; ++i_2) {
        (*C)[(i_0 + 21)][i_1][i_2] = ((*B)[(i_0 + 21)][i_1][i_2] - (*C)[(i_0 + 21)][(i_1 - 1)][i_2]);
      }
    }
    for (int i_1 = 1; i_1 < 499; ++i_1) {
      for (int i_2 = 1; i_2 < 499; ++i_2) {
        (*C)[(i_0 + 22)][i_1][i_2] = ((*B)[(i_0 + 22)][i_1][i_2] - (*C)[(i_0 + 22)][(i_1 - 1)][i_2]);
      }
    }
    for (int i_1 = 1; i_1 < 499; ++i_1) {
      for (int i_2 = 1; i_2 < 499; ++i_2) {
        (*C)[(i_0 + 23)][i_1][i_2] = ((*B)[(i_0 + 23)][i_1][i_2] - (*C)[(i_0 + 23)][(i_1 - 1)][i_2]);
      }
    }
    for (int i_1 = 1; i_1 < 499; ++i_1) {
      for (int i_2 = 1; i_2 < 499; ++i_2) {
        (*C)[(i_0 + 24)][i_1][i_2] = ((*B)[(i_0 + 24)][i_1][i_2] - (*C)[(i_0 + 24)][(i_1 - 1)][i_2]);
      }
    }
    for (int i_1 = 1; i_1 < 499; ++i_1) {
      for (int i_2 = 1; i_2 < 499; ++i_2) {
        (*C)[(i_0 + 25)][i_1][i_2] = ((*B)[(i_0 + 25)][i_1][i_2] - (*C)[(i_0 + 25)][(i_1 - 1)][i_2]);
      }
    }
    for (int i_1 = 1; i_1 < 499; ++i_1) {
      for (int i_2 = 1; i_2 < 499; ++i_2) {
        (*C)[(i_0 + 26)][i_1][i_2] = ((*B)[(i_0 + 26)][i_1][i_2] - (*C)[(i_0 + 26)][(i_1 - 1)][i_2]);
      }
    }
    for (int i_1 = 1; i_1 < 499; ++i_1) {
      for (int i_2 = 1; i_2 < 499; ++i_2) {
        (*C)[(i_0 + 27)][i_1][i_2] = ((*B)[(i_0 + 27)][i_1][i_2] - (*C)[(i_0 + 27)][(i_1 - 1)][i_2]);
      }
    }
    for (int i_1 = 1; i_1 < 499; ++i_1) {
      for (int i_2 = 1; i_2 < 499; ++i_2) {
        (*C)[(i_0 + 28)][i_1][i_2] = ((*B)[(i_0 + 28)][i_1][i_2] - (*C)[(i_0 + 28)][(i_1 - 1)][i_2]);
      }
    }
    for (int i_1 = 1; i_1 < 499; ++i_1) {
      for (int i_2 = 1; i_2 < 499; ++i_2) {
        (*C)[(i_0 + 29)][i_1][i_2] = ((*B)[(i_0 + 29)][i_1][i_2] - (*C)[(i_0 + 29)][(i_1 - 1)][i_2]);
      }
    }
  }
...
void check() {
  ...
  for (int i_0 = 1; i_0 < 499; ++i_0) {
    for (int i_1 = 1; i_1 < 499; ++i_1) {
      for (int i_2 = 1; i_2 < 499; ++i_2) {
        (*Ctest)[i_0][i_1][i_2] = ((*Btest)[i_0][i_1][i_2] - (*Ctest)[i_0][(i_1 - 1)][i_2]);
      }
    }
  }
  int pass = 1;
